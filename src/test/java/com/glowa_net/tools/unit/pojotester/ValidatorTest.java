...
import com.glowa_net.tools.unit.sample.invalid.NoGetterSample;
import com.glowa_net.tools.unit.sample.simple.SimpleSample;

public class ValidatorTest {

    private PojoValidator       o2T;
    private String              package2Test        = "com.glowa_net.tools.unit.sample.simple";
    private String              packageInvalid2Test = "com.glowa_net.tools.unit.sample.invalid";
